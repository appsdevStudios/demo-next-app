      ...
      <div className="btm-nav border-t-[1px] border-gray-800">
        <div className='flex flex-row'>
          ...
          <div className='w-12 text-center'>
            <svg className="w-5 h-5 text-slate-600 hover:text-slate-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
